 ...
 * @author bobgils
 */
public class Exercise24_01Test {
  public static void main(String[] args) {
    new Exercise24_01Test();
  }

  public Exercise24_01Test() {
...
class MyArrayList<E> implements MyList<E> {
    ...
    public Object[] toArray() {
        ...
        System.arraycopy(data, 0, converted, 0, size);
        return converted;
    }
    ...
    public boolean removeAll(@NotNull Collection<?> col) {
        for (Object element : col) this.remove(element);
        return false;
    }
    ...
    public boolean retainAll(@NotNull Collection<?> col) {
        E[] dataCopy = (E[]) this.toArray();
        for (E element : dataCopy) if (!col.contains(element)) this.remove(element);
        return false;
    }
